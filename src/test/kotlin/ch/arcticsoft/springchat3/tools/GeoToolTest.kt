...
class GeoToolTest {
    ...
    @Test
    fun `CURRENT_LOCATION sentinel is stable and non-blank`() {
        // ChatAgent/WeatherTool compare against this literal string, so it must
        // never be blank or change silently between releases.
        assertTrue(GeoTool.CURRENT_LOCATION.isNotBlank())
        assertEquals("CURRENT_LOCATION", GeoTool.CURRENT_LOCATION)
    }
